...
describe('Unit::Date Utils', () => {
  describe('checkDateFormat()', () => {
    ...
    it('should return false when incorrect month is used', function() {
    ...
    it('should return false when incorrect day is used', function() {
    ...
    it('should return false when incorrect year is used', function() {
    ...
    it('should return false when incorrect delimiter is used', function() {
      expect(checkDateFormat('1991/01-28')).to.be.false;
      expect(checkDateFormat('1991/01/28')).to.be.false;
      expect(checkDateFormat('1991-01/28')).to.be.false;
    });
    it('should return false when empty string is used', function() {
      expect(checkDateFormat('')).to.be.false;
    });
    it('should return false when null is used', function() {
      expect(checkDateFormat(null)).to.be.false;
    });
    it('should return false when date is undefined', function() {
      expect(checkDateFormat(undefined)).to.be.false;
    });
  });
  
  describe('equalDate()', () => {
    it('should return true when dates are equal', function() {
      expect(equalDate(new Date('2010-04-04'),new Date('2010-04-04'))).to.be.true;
    });
    it('should return false when dates are not equal', function() {
      expect(equalDate(new Date('2011-04-04'),new Date('2010-04-04'))).to.be.false;
    });
    it('should throw an error when something else than a date object is passed', function() {
